...
- Password access: expired `UserPosition` cargo is omitted from the territory list and its profile is `403` while login still succeeds ([sitmun-backend-core#184](https://github.com/sitmun/sitmun-backend-core/issues/184); `e2e/viewer/password-access.spec.ts`, project `viewer-password`)
