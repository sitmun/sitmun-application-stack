...
- User form **Positions**: Alta immediately before Baja; empty Alta placeholder; Alta edit persist; Baja inclusive tooltip; hidden for `public`; `es`/`en` copy; pre-2000 Alta cell; viewer cannot write Alta; 20-row open under 3s ([sitmun-admin-app#462](https://github.com/sitmun/sitmun-admin-app/issues/462); `e2e/admin/forms/user-positions.spec.ts`, project `admin-forms`). Inverted-interval warning UI waits for [sitmun-backend-core#184](https://github.com/sitmun/sitmun-backend-core/issues/184)
