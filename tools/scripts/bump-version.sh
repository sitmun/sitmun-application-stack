...
BUMP_ENTRIES=(
  ...
  "front/admin/sitmun-admin-app/src/environments/environment.e2e.ts|  version: '{{VERSION}}',|  version: '{{NEW}}',"
  ...
  "front/viewer/sitmun-viewer-app/src/environments/environment.e2e.ts|  version: '{{VERSION}}',|  version: '{{NEW}}',"
